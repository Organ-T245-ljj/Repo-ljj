...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        <form class="form-horizontal form-label-left" action="${pageContext.request.contextPath }/appinfo/appinfomodifysave" method="post" enctype="multipart/form-data">
           ...
           <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
				...
				<c:if test="${appInfo.logoLocPath !=null}">
					<div id="logoFile" >
						<p><img src="${appInfo.logoLocPath}" width="100px;"/> &nbsp;&nbsp;
						<a href="javascript:;" onclick="delfile(${appInfo.id});">删除</a>${appInfo.id}
						</p>
					</div>
				</c:if>
