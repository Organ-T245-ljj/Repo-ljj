    ...
    <div class="x_panel">
	  ...
	  <p class="text-muted font-13 m-b-30"></p>
						...
						<tbody>
							<c:forEach var="appVersion" items="${appVersionList}" varStatus="status">
								<tr role="row" class="odd">
									...
									<td>
									<a href="${pageContext.request.contextPath }/appVersion/download?filename=${appVersion.apkFileName}">${appVersion.apkFileName}</a>
									</td>
        ...
        <div class="x_content" style="display: block;">
         <br>
        <form class="form-horizontal form-label-left" action="${pageContext.request.contextPath}/appVersion/addversionsave" method="post" enctype="multipart/form-data">
