...
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form method="post" action="${pageContext.request.contextPath }/appinfo/list">
			    ...
			    <ul>
					...
					<li>
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select id="queryCategoryLevel1" name="aa1" class="form-control">
					...
					<li>
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="hidden" value="${categoryLevel2}" id="pid"/>
							<input type="hidden" name="categorylevel2list" id="categorylevel2list"/>
        						<select name="queryCategoryLevel2" id="queryCategoryLevel2" class="form-control">
        							<c:if test="${categoryLevel2Lists != null }">
									   <option value="0">--请选择--</option>
									   <c:forEach var="appCategory" items="${categoryLevel2Lists}">
					...
					<li>
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="hidden" value="${categoryLevel3}" id="pid3"/>
        						<select name="queryCategoryLevel3" id="queryCategoryLevel3" class="form-control">
        							<c:if test="${categoryLevel3Lists != null }">
									   <option value="0">--请选择--</option>
									   <c:forEach var="appCategory" items="${categoryLevel3Lists}">
	...
	<div class="x_panel">
		<div class="x_content">
			...
			<div id="datatable-responsive_wrapper"
				...
				<div class="row">
					<div class="col-sm-12">
					<a href="${pageContext.request.contextPath}/appinfo/appinfoadd" class="btn btn-success btn-sm">新增APP基础信息</a>
							...
							<tbody>
								<c:forEach var="appInfo" items="${appInfoList }" varStatus="status">
									<tr role="row" class="odd">
										...
										<td>${appInfo.categoryLevel1Name } -> ${appInfo.categoryLeve21Name} -> ${appInfo.categoryLeve31Name }</td>
                        ...
                        <li>
                        	<c:choose>
								<c:when test="${appInfo.status == 2 || appInfo.status == 5}">
									<a class="saleSwichOpen" saleSwitch="open" appinfoid=${appInfo.id }  appsoftwarename=${appInfo.softwareName } data-toggle="tooltip" aa="上架" data-placement="top" title="" data-original-title="恭喜您，您的审核已经通过，您可以点击上架发布您的APP">上架</a>
								</c:when>
								<c:when test="${appInfo.status == 4}">
								<a class="saleSwichClose" saleSwitch="close" appinfoid=${appInfo.id }  appsoftwarename=${appInfo.softwareName } data-toggle="tooltip" aa="下架" data-placement="top" title="" data-original-title="您可以点击下架来停止发布您的APP，市场将不提供APP的下载">下架</a>
								</c:when>															
							</c:choose>				
                        </li>
				...
				<div class="row">
					<div class="col-sm-5">
						<div class="dataTables_info" id="datatable-responsive_info"
							role="status" aria-live="polite">共${num}条记录
							${cur}/${pageCount}页</div>
					</div>
					<div class="col-sm-7">
							...
							<ul class="pagination">
								<c:if test="${cur > 1}">
									...
									<li class="paginate_button "><a
										href="javascript:page_nav(document.forms[0],${cur-1});"
