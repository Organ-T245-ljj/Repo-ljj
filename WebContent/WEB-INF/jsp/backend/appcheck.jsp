  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content1">
        <form class="form-horizontal form-label-left" action="${pageContext.request.contextPath }/backendUser/checksave" method="post">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" class="form-control col-md-7 col-xs-12" 
              	value="${appInfo.categoryLevel1Name} --> ${appInfo.categoryLeve21Name} --> ${appInfo.categoryLeve31Name}" readonly="readonly">
            </div>
          </div>
          <div class="item form-group">
           ...
           <div class="item form-group">
            ...
            <c:choose> 
			  ...
			  <c:otherwise>   
			    ...
			    <a href="${pageContext.request.contextPath }/appVersion/download?filename=${appVersion.apkFileName}" >下载</a>
			    </p>
			  </c:otherwise> 
            </c:choose> 
            </div>
