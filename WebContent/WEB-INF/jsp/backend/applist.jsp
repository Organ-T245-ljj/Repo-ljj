...
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form method="post" action="${pageContext.request.contextPath }/backendUser/list">
								...
								<c:forEach var="appInfo" items="${appInfoList }" varStatus="status">
									<tr role="row" class="odd">
										...
										<button type="button" class="btn btn-default checkApp" 
											...
											data-toggle="tooltip" data-placement="top" title="" data-original-title="查看并审核APP">审核${appInfo.versionId}</button>
										</td>
									</tr>
								</c:forEach>
							</tbody>
