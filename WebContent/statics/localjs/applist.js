...
$(".checkApp").on("click",function(){
	...
	alert(vid+"      "+status)
	if(status == "1" && vid != "0" && vid != null){//待审核状态下才可以进行审核操作
		alert("y")
		window.location.href="/appinfo/backendUser/check?aid="+ obj.attr("appinfoid") + "&vid="+ obj.attr("versionid");
	}else if(vid != "0" || vid != null){
